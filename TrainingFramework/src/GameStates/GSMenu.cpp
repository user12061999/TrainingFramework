...
void GSMenu::Init()
{
	...
	button->Set2DPosition((float)screenWidth / 2, 200);
	...
	button->Set2DPosition((float)screenWidth / 2, 300);
	button->SetSize(200, 50);
	button->SetOnClick([]() {
	...
	button = std::make_shared<GameButton>(model, shader, texture);
	button->Set2DPosition((float)screenWidth / 2, 400);
	button->SetSize(200, 50);
	button->SetOnClick([]() {
	...
	m_Text_gameName->Set2DPosition(Vector2((float)screenWidth / 2 - 80, 120));
}
